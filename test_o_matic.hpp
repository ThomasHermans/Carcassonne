...
#define TEST_O_MATIC_TEST_DEFINITION_BEGIN \
    namespace { namespace test_o_matic_defs_ { \
        struct TEST_O_MATIC_STRUCT_NAME : ::test_o_matic::detail::test_base_

#define TEST_O_MATIC_TEST_DEFINITION_END(strliteral) \
        { \
            TEST_O_MATIC_STRUCT_NAME(::test_o_matic::logger &lgr) : ::test_o_matic::detail::test_base_(lgr) { } \
            void tom_run_(); \
            static void tom_func_(::test_o_matic::logger &lgr) { TEST_O_MATIC_STRUCT_NAME t(lgr); t.tom_run_(); } \
        }; \
        ::test_o_matic::test \
...
#define TEST_O_MATIC_HEADER(expr_literal, result_index) \
    ::test_o_matic::data("line", __LINE__) \
                        ("file", __FILE__) \
                        ("statement", expr_literal) \
                        ("result", ::test_o_matic::result_names[(result_index)])
...
#define TEST_O_MATIC_THROWS_MIDDLE(expr_literal) \
        ...
        catch (::test_o_matic::detail::to_const_ref<
...
// --------------------------
#define ABORT() \
    throw ::test_o_matic::data("line", __LINE__)("file", __FILE__)("reason", "test ABORT()ed")("result", "aborted");
